...
plot_seed <- treeChops$Seed %>% 
  ...
  ggplot(aes(x = (mya))) + 
  geom_line(aes(y = PD, colour = "PD"), linewidth = 2.5, color = "black", alpha = 0.7) + 
  geom_line(aes(y = SR*scl, colour = "SR"), linewidth = 2.5, color = "red", alpha = 0.7) + 
